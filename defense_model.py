...
def test(data,
    ...
    if training:  # called by train.py
        ...
        print(model)
        model = nn.Sequential(*list(model.children())[0][:11])
        print(model)
...
if __name__ == '__main__':
    ...
    parser2.add_argument('--weights', nargs='+', type=str, default='./runs/train/exp43/weights/best.pt', help='model.pt path(s)')
    ...
    parser2.add_argument('--task', default='test', help="'val', 'test', 'study'")
