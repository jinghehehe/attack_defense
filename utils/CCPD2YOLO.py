import cv2
import os, sys
#path ="/data/private_data/jf_private/CCPD2020/CCPD2019/splits/test.txt"
path ="/data/private_data/jf_private/CCPD2020/CCPD2020/ccpd_green/train.txt"
path_='/home/jf/detect/CCPD/labels/train/'
lable=0
item=0

for img_name in open(path):
    print(img_name)
    # 读取图片的完整名字
    ...
    print(new_obj_name)
    txt = open(path_+new_obj_name+'.txt', 'w+')  # 准备写入
